  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {socialLinks.map((link, index) => (
              <motion.a
                ...
                className="group bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-700 hover:border-blue-500 transition-all duration-300 transform hover:scale-105"
              >
                <div className="flex items-center space-x-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-semibold mb-2">{link.name}</h3>
                    <p className="text-gray-400 mb-3">{link.description}</p>
                    <div className="flex items-center space-x-2">
                      <span className="text-sm text-gray-500">Followers:</span>
                      <span className="text-sm font-semibold text-blue-400">{link.followers}</span>
                    </div>
                  </div>
                </div>
              </motion.a>
        ...
        >
          <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 backdrop-blur-sm p-12 rounded-xl border border-blue-500/30">
